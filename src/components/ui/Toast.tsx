...
const Toast: React.FC<ToastProps> = ({
  ...
  const animationClass = isExiting ? 'opacity-0 translate-y-2' : 'opacity-100 translate-y-0';

  return (
    <div
      className={`fixed bottom-4 right-4 z-50 transition-all duration-300 ease-out ${animationClass}`}
    >
      <div
        className={`flex items-center gap-3 ${style.bg} border-l-4 rounded-md shadow-card-hover px-4 py-3 min-w-[320px] max-w-md`}
      >
